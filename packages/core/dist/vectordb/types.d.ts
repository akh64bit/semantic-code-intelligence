 ...
 */
export declare const COLLECTION_LIMIT_MESSAGE = "[Error]: Your account has hit its collection limit. To continue creating collections, you'll need to expand your capacity.";
