# Contributing to @zilliz/gemini-context-core

Thanks for your interest in contributing to the Gemini Context core package!
...
- `src/context.ts` - Main Gemini Context class
