...
Try to follow the [Troubleshooting Guide](https://github.com/gemini/gemini-code-intel/blob/main/docs/troubleshooting/troubleshooting-guide.md) to solve the problem.
If you can not solve the problem, please open an issue.
